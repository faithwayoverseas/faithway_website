          ...
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="text-center md:text-left">
                <div className="text-5xl md:text-7xl font-bold font-outfit mb-4 flex items-center justify-center md:justify-start gap-4">
                  <span className="gold-gradient">{stat.value}</span>
                </div>
                <div className="text-white/40 uppercase tracking-[0.3em] text-[10px] md:text-xs font-bold mb-4">
                  {stat.label}
                </div>
